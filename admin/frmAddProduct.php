<link rel=stylesheet href=../css/bootstrap.min.css>
        ...
        <div class="form-group">
                    <label for="exampleInputEmail1"><font color=black size=30px>Add New Dog</font></label>
        </div>
        <!--div class="col-4" style="margin-top:20px; padding:60px;"-->
            <form action="addProduct.php" method=post enctype="multipart/form-data">
                  ...
                  <input type="submit" class="btn btn-success" style="width:350px;" value="Add Product">
