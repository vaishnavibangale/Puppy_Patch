...
<div class="container my-4"  > 
    <div class=row>
        ...
        <div class="col-4 shadow-lg p-3 mb-5 bg-white rounded" style="margin-top:100px; padding:60px;" >
            <form action="login.php" method=post>
                ...
                <div class="form-group" style="margin-top:20px;">
                    <a href=register.php class="btn btn-info" colspan=2 style="width:350px;">New User ? Register<a> 
